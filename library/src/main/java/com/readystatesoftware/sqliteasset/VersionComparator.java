 ...
 *
 * <p>For example, this fixes an upgrade that would apply 2 different upgrade files from version 9
 * to 11 (<code>..._updated_9_10</code> and <code>..._updated_10_11</code>) from using the
...
class VersionComparator implements Comparator<String> {
   ...
   * @exception SQLiteAssetException thrown if the strings are not in the correct upgrade script
   *     format of: <code>databasename_fromVersionInteger_toVersionInteger</code>
   */
  @Override
